...
public:
    ...
    void setupUi(QWidget *Goods_Frame)
    {
        ...
        Goods_Frame->setStyleSheet(QLatin1String("#Goods_Frame{\n"
...
"}"));
        ...
        label_change_num->setObjectName(QStringLiteral("label_change_num"));
        QFont font1;
        font1.setFamily(QStringLiteral("Cascadia Mono"));
    ...
    void retranslateUi(QWidget *Goods_Frame)
    {
        ...
        label_goods_pic->setText(QApplication::translate("Goods_Frame", "\345\233\276\347\211\207", Q_NULLPTR));
        label_goods_name->setText(QApplication::translate("Goods_Frame", "\345\272\223\345\255\230", Q_NULLPTR));
        ...
        label_change_num->setText(QApplication::translate("Goods_Frame", "0", Q_NULLPTR));
