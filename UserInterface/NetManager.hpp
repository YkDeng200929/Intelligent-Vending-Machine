...
#define MACRO_GET_ADMIN_CODE 1122  // 获取管理员授权码
#define MACRO_GET_PAY_CODE   1123  // 获取支付二维码

// 应答码
#define MACRO_PAY_SUCCESS       100  // 用户支付成功
#define MACRO_PAY_FAIL          104  // 用户支付失败
#define MACRO_PAY_CODE_OK       110  // 获取支付二维码成功
#define MACRO_PAY_CODE_FAIL     114  // 获取支付二维码失败
#define MACRO_ADD_GOOD_SUCCESS  200  // 管理员补货成功
#define MACRO_ADD_GOOD_FAIL     204  // 管理员补货失败
#define MACRO_GET_CODE_OK       210  // 获取管理员授权码成功
#define MACRO_GET_CODE_FAIL     214  // 获取管理员授权码失败
...
signals:
    // 成功获取所有商品信息
    void sig_get_all_goods_info_success(QJsonArray all_goods_info);
    // 获取所有商品信息失败
    void sig_get_all_goods_info_fail();
    // 用户支付成功
    void sig_user_pay_success();
    // 用户支付失败
    void sig_user_pay_fail();
    // 成功获取到授权码
    void sig_admin_code_ok(QJsonValue code);
    // 获取授权码失败
    void sig_admin_code_fail();
    // 成功获取到二维码信息
    void sig_get_pay_code_ok(QJsonValue pay_code);
    // 获取二维码信息失败
    void sig_get_pay_code_fail(QJsonValue pay_code);
