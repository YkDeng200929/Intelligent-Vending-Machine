...
void Goods_Frame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Goods_Frame *_t = static_cast<Goods_Frame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (Goods_Frame::*_t)(QString , int , int , int );
...
const QMetaObject Goods_Frame::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Goods_Frame.data,
      qt_meta_data_Goods_Frame,  qt_static_metacall, nullptr, nullptr}
};
